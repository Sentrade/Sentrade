...
result = open("./DecisionTree_results.csv", "w")
...
for response in response_list:
    for features in features_list:
        ...
        result.write('min_samples_split,')
        ...
        for min_samples_split in range(2, 6):
            ...
            result.write(str(min_samples_split) + ',')
            ...
            for company in company_list:
                ...
                x_train, x_test, y_train, y_test = train_test_split(total_df[features].to_numpy(),
                                                                    ...
                                                                    shuffle=True,
                                                                    random_state=500)
                accuracy = classifier_run(clf, "DecisionTree", x_train, x_test, y_train, y_test)
