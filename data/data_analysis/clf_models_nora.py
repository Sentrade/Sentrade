...
distinct_features_list = [#["7_day_sentiment_score", "3_day_sentiment_score","1_day_sentiment_score","volume"],
                          # (criterion='entropy', max_leaf_nodes=30, min_impurity_split=0.01)
                          # accuracy = 0.48
                          #["7_day_bert_sentiment_score","3_day_bert_sentiment_score","volume"]
                          # (criterion='entropy', max_leaf_nodes=15, min_impurity_split=0.05),
                          #accuracy = 0.48
                          #["7_day_sentiment_score"],
                          ["7_day_bert_sentiment_score"],
                          #(criterion='entropy', max_leaf_nodes=25,max_depth=20,min_impurity_decrease=0.005),
                          #accuracy = 0.51
                          #["3_day_sentiment_score"],
                          #["3_day_bert_sentiment_score"],
                          #(criterion='entropy', max_leaf_nodes=25,max_depth=15,min_impurity_decrease=0.005),
                          #accuracy =0.50
...
alg_dict = {#"KNN": KNeighborsClassifier(),
             "DecisionTree": DecisionTreeClassifier(criterion='entropy', max_leaf_nodes=25,max_depth=20,min_impurity_decrease=0.005),
            #"SVM": SVC(gamma='auto'),
            }
